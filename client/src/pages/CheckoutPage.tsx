...
interface CheckoutPageProps {
  cart: CartItem[];
  clearCart: () => void;
  setPage: Dispatch<SetStateAction<'register' | 'login' | 'products' | 'profile' | 'checkout' | 'cart' | 'payment-success'>>;
}

const CheckoutPage: React.FC<CheckoutPageProps> = ({ cart, clearCart, setPage }) => {
